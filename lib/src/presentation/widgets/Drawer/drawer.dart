...
import 'package:next_shop_app/src/presentation/widgets/Drawer/about_tile.dart';
import 'package:next_shop_app/src/presentation/widgets/Drawer/drawer_tile.dart';
      ...
      child: Column(
        children: [
          ...
          ListBody(
            children: const [
              ...
              DrawerTile(
                ...
                pageTitle: AppRoutes.allCategoriesScreen,
              ),
              Divider(
                height: 0.0,
                thickness: 1.0,
              ...
              DrawerTile(
                ...
                pageTitle: AppRoutes.cartScreen,
                showCartCount: true,
              ),
              Divider(
                height: 0.0,
          ...
          const DrawerTile(
            ...
            title: 'Profile',
            pageTitle: AppRoutes.userScreen,
          ),
          const Divider(
            height: 0.0,
            thickness: 1.0,
          ...
          ListTile(
            ...
            onTap: () async {
              if (isAuth) {
                ...
                if (context.mounted) await context.read<LoginCubit>().logout();
                if (context.mounted) {
